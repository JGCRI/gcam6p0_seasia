...
module_energy_X232.industry_Subregions_Malaysia <- function(command, ...) {
  if(command == driver.DECLARE_INPUTS) {
    return(c(FILE = "common/GCAM_region_names",
             FILE = "breakout/Subregions_Malaysia_industry_shares",
    ...
    Subregions_Malaysia_industry_share <- get_data(all_data,"breakout/Subregions_Malaysia_industry_shares")
    ...
    Subregions_Malaysia_industry_share %>%
      dplyr::filter(type=="other") %>%
      dplyr::mutate(share=share/100)-> Subregions_Malaysia_industry_share_other

    X232.StubTechCalInput_indenergy_Subregions_Malaysia <- L232.StubTechCalInput_indenergy %>%
      downscale_to_breakout_regions(data = .,
                                    composite_region = "Malaysia",
                                    disag_regions = c(subregions),
                                    share_data = Subregions_Malaysia_industry_share_other, value.column = "calibrated.value", share.column = "share")
    ...
    X232.StubTechProd_industry_Subregions_Malaysia <- L232.StubTechProd_industry %>%
      downscale_to_breakout_regions(data = .,
                                    composite_region = "Malaysia",
                                    disag_regions = c(subregions),
                                    share_data = Subregions_Malaysia_industry_share_other, value.column = "calOutputValue", share.column = "share")

    X232.BaseService_ind_Subregions_Malaysia <- L232.BaseService_ind %>%
      downscale_to_breakout_regions(data = .,
                                    composite_region = "Malaysia",
                                    disag_regions = c(subregions),
                                    share_data = Subregions_Malaysia_industry_share_other, value.column = "base.service", share.column = "share")
    ...
    X232.pol_emissions_ind_Subregions_Malaysia <- L201.en_pol_emissions %>%
      ...
      downscale_to_breakout_regions(data = .,
                                    composite_region = "Malaysia",
                                    disag_regions = c(subregions),
                                    share_data = Subregions_Malaysia_industry_share_other, value.column = "input.emissions", share.column = "share")
